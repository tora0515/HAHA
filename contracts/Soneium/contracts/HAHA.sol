...
// Contract for Mother of Memes (HAHA) Token on Soneium with a fixed supply and burn mechanism
contract HAHA is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("Mother of Memes", "HAHA") Ownable(msg.sender) {
